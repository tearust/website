...
<div class="c-md">
  <h2>You do not have to be a veteran to try TEA dApps. We provide three levels of demo dapps you can try.</h2>
  ...
  <p>
    ...
    You do not need to deploy your own dapp in this step. A demo Tensorflow image recognization dapp has been deployed by TEA developers ready for you.

    A pre-deployed picture of a lion is feed into the Tensorflow wasm function.
    After a few seconds, one of running TEA nodes (miners) will be randomly selected and execute the code. You can see the result on your browser.
  ...
  <p>
    ...
    <p>You might be confused, but no worries, you do not need to understand to try it. You just need to click <a href=""> run demo dApp</a> follow the <a href="doc_content/Online-demo.md#/doc_content/%2F01-Online-demo.md"> Instruction </a> to complete the online demo.
  </p>
  <p>
  ...
  <div class="">Please follow the instruction to deploy your own picture and run the same wasm function on this picture.</div>
  <p>
  ...
  <p>
    ...
    <ul>A Mac or Linux computer. Windows should work too, but we did not get chance to test. On your own risk</ul>
    <ul>Docker, Docker-compose installed</ul>
    <ul>A Chrome or Firefox web browser which supports Polkadot plugin/extension</ul>
  </p>
  <p>
  ...
  <div class="">  This is your TEA node, not ours. So you will need to generate your own TEA ID (an ED25519 keypair). </div>
<div class="">How to generate Tea Id?</div>
<h4> PAYMENT_ACCOUNT  </h4>
<div class="">Your TEA node makes a profit, so you need an account to receive the money. Please create an account here. Once you have the account ID, save it to `PAYMENT_ACCOUNT=`</div>
<h4> PUBLIC_URLS</h4>
<div class="">Suppose your TEA node deploys with a public IP address. You can set this value to your IP with port number 8000. For example 1.2.3.4:8000. </div>
<div class="">Suppose your TEA node deploys to your local network without a public IP. You can use your internal IP address here, such as 192.168.1.9:8000. However, your node can only accept tasks from your internal network.</div>
<div class="">This Public URL will expose to the public so that others may find you and send delegation task to you. However, if you just want to be a Repinner or Delegator, you do not need Public URL. It just works fine with LibP2P network.</div>
</div>
</div>
</template>
<script>
